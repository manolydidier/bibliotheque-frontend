...
/* =========================
   ...
   ✅ LARGEUR alignée à OrganigrammeMIRADIAPro:
      - wrapper: py-12 px-4 sm:px-6 lg:px-8
      - container: max-w-[1700px] px-2 sm:px-4 lg:px-8 py-8
========================= */
  ...
  return (
    <div className="min-h-screen flex items-center w-full bg-[#eef5fb] dark:bg-gradient-to-b dark:from-[#0B1626] dark:via-[#070F1C] dark:to-[#050A12]">
      <div className="relative w-full min-h-screen flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        {/* ✅ même container largeur que OrganigrammeMIRADIAPro */}
        <main className="relative flex-col w-full max-w-[1700px] px-2 sm:px-4 lg:px-8 py-8">
          {/* =========================
