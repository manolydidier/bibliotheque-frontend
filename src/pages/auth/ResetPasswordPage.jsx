...
const PasswordStrength = ({ value = '' }) => {
  ...
  const label = !value ? 'Commencez à taper votre mot de passe'
...
const ResetPasswordIllustration = () => (
  <div className="relative">
    ...
    <div className="absolute inset-0 rounded-full bg-gradient-to-r from-purple-400/20 to-pink-400/20 blur-3xl animate-pulse"></div>
  </div>
);
  ...
  return (
    <div className="relative min-h-screen w-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute top-10 left-10 w-96 h-96 bg-gradient-to-r from-blue-400/10 to-purple-400/10 rounded-full blur-3xl" />
        <div className="absolute bottom-10 right-10 w-[32rem] h-[32rem] bg-gradient-to-r from-indigo-400/10 to-cyan-400/10 rounded-full blur-3xl" />
        ...
        <main className="flex items-center justify-center p-6 lg:p-12">
          ...
          >
            ...
            <div className="lg:hidden text-center mb-6">
              <div className="mx-auto mb-4 w-12 h-12 rounded-2xl bg-gradient-to-r from-indigo-500 to-purple-600 flex items-center justify-center shadow-lg">
                <SecurityIcon />
              </div>
                  ...
                  <div>
                    <p className="text-red-700 text-sm font-medium">
                      {!token
                        ...
                        : 'Email manquant dans le lien. Relancez la procédure.'}
                    </p>
                  </div>
                </div>
              </div>
            ...
            {done ? (
              <div className="text-center py-8">
                <div className="mb-6">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">Succès !</h3>
                ...
                <Link
                  to="/auth"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                >
              ...
              <form onSubmit={submit} className="space-y-6" noValidate aria-busy={busy}>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500 mt-1" role="note">
                    L’adresse e-mail est définie par le lien de réinitialisation et ne peut pas être modifiée.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-12 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300 bg-white/50 backdrop-blur-sm hover:bg-white/70 placeholder-gray-400"
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
                ...
                <button
                  ...
                  className={`w-full py-3 px-6 rounded-xl font-semibold transition-all duration-300 shadow-lg transform ${
                    valid && !busy
                      ? 'bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0'
                ...
                {/* Retour login + conseils */}
                <div className="text-center pt-4">
                  <Link
                    to="/auth"
                    className="inline-flex items-center gap-2 text-gray-600 hover:text-indigo-600 transition-colors duration-300 text-sm font-medium group"
                  >
                ...
                <div className="mt-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-blue-900 mb-1">Conseils de sécurité</h4>
      ...
      <div className="pointer-events-none">
        <div className="absolute -top-4 -right-4 w-8 h-8 bg-gradient-to-r from-pink-400 to-purple-500 rounded-full opacity-20 animate-pulse"></div>
